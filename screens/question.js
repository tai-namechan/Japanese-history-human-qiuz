const questions = [
        ...
        questionOptionsThird: [
            {
                ...
                readText: 'かまくらばくふとそれをだとうしようとするものたちのたたかいでおよそ２ねんかんにわたりあらそいがつづいたよ。'
            },
            {
    ...
    },
    {
        ...
        questionOptionsSecond: [
            ...
            {
                questionText: 'あなたを一言で言うなら？',
                answerText: '明治維新後の日本を牽引し、日本を近代化に導いた立役者じゃな！',
                readText: '明治維新ごの日本を牽引し、日本を近代化に導いたたてやくしゃじゃな！',
            },
            {
        ...
        questionOptionsThird: [
            ...
            {
                questionText: '死因は何ですか？',
                answerText: '中国のハルビン駅で、安重根に暗殺されたんじゃ。',
                readText: '中国のハルビン駅で、アン・ジュングンに暗殺されたんじゃ。',
            },
        ],
        questionOptionsFourth: [
            {
    ...
    },
    {
        ...
        questionOptionsSecond: [
            ...
            {
                questionText: '何か成し遂げたことはありますか？',
                answerText: '征夷大将軍になったことじゃ',
                readText: 'せいいたいしょうぐんになったことじゃ',
            },
            {
                questionText: 'あなたは社会にどのような影響を与えましたか？',
    ...
    },
    {
        ...
        questionOptionsFourth: [
            {
                questionText: '偉業はなんかある？',
                answerText: '南北朝合一したったわい。あと、金があまってたから別荘建てたったわい！ちなみにそれが、金閣なんじゃ',
                readText: 'なんぼくちょうごういつしたったわい。あと、金があまってたからべっそう建てたったわい！ちなみにそれが、きんかくなんじゃ'
            },
            {
                questionText: '親戚に有名な人いる？',
                answerText: '祖父が足利尊氏なんじゃ。誠に誇り高きことであるのお。',
                readText: 'そふがあしかがたかうじなんじゃ。まことにほこりたかきことであるのお。'
            },
            {
                questionText: '',
                answerText: ''
    ...
    },
    {
        ...
        questionOptionsSecond: [
            {
                ...
                answerText: '源義家だね',
                readText: 'みなもとのよしいえだね'
            },
            {
                questionText: 'あなたの黒歴史を教えて？',
        ...
        questionOptionsThird: [
            ...
            {
                questionText: '実は〇〇な話ってある？',
                answerText: '最初は鎌倉幕府側の人間だったんだけど、途中で裏切って後醍醐天皇側についたんじゃ',
                readText: 'さいしょはかまくらばくふがわのにんげんだったんだけど、とちゅうでうらぎってごだいごてんのうがわについたんじゃ'
            },
        ],
        questionOptionsFourth: [
            {
            ...
            },
            {
                ...
                answerText: '室町幕府作ったことじゃ。新田義貞、楠木正成、後醍醐天皇の新政府を倒した後に、光明天皇をたててと色々苦労して幕府を作ったんよ。',
                readText: 'むろまちばくを作ったことじゃ。にったよしさだ、くすのきまさしげ、ごだいごてんのうのしんせいふをたおしたあとに、こうめいてんのうをたててといろいろくろうしてばくふをつくったんよ'
            },
        ],
        questionOptionsFifth: [
            {
    ...
    },
    {
        ...
        questionOptions: [
            ...
            {
                questionText: 'どんな人なの？',
                answerText: 'わしは人を平気で騙せる非情な人間じゃった',
                readText: 'わしは人を平気で騙せる非情な人間じゃった',
            },
        ],
        questionOptionsSecond: [
            {
